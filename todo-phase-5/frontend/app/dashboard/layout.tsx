...
import { TaskUpdatesProvider } from "@/components/task-updates-provider";
...
export default function DashboardLayout({
  ...
  const { isPending, isAuthenticated, session } = useRequireAuth();
  ...
  return (
    <SidebarProvider>
      <TaskUpdatesProvider userId={session?.user?.id || null}>
